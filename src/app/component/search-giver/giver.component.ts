...
@Component({
  selector: 'app-giver-search',
  templateUrl: './giver.component.html',
  styleUrls: ['./giver.component.scss'],
})
export class GiverSearchComponent implements OnInit {
    ...
    viewProfil(utilisateur :  any) {
      localStorage.setItem('view_giver_profil', JSON.stringify(utilisateur));
      this.router.navigate(['user/profil-view-giver']);
    }
